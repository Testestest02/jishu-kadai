            ...
            <div class="card card-primary">
                ...
                <div class="card-body mx-3 my-3">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <textarea class="form-control ml-3" id="name" name="name" placeholder="商品名" wrap="hard">{{ old('name') }}</textarea>
                    </div>
                    <!-- 商品種別 -->
                    <div class="form-group mb-4">
                    ...
                    <div class="form-group mb-5">
                        <div class="form-group">
                        <label class="h5" for="status">公開状況</label><span class="h5 bg-danger text-white ml-1">必須</span>
                        </div>
                        <div class="form-group form-check-inline ml-3">
