            ...
            <div class="card card-primary">
                ...
                <form method="POST" action="{{ url('items/update',  ['id'=>$item->id]) }}" id="update">
                    ...
                    <div class="card-body mx-3 my-3">
                        ...
                        <input type="text" class="form-control ml-3" value="{{ old('name', $item->name) }}" id="name" name="name">
                        </div>
                        <!-- 商品種別 -->
                        <div class="form-group mb-4">
                    ...
                    <div class="card-footer">
                        <!-- 商品登録ボタン -->
                        <button type="submit" class="btn btn-primary" id="edit-item-{{ $item->id }}" form="update">
                        商品登録</button>
                        <!-- 商品削除ボタン -->
                        <button type="submit" class="btn btn-primary" id="delete-item-{{ $item->id }}" form="delete" onclick='return confirm("商品情報を削除してもよろしいですか");'>
                        商品削除</button>
                    </div>
                <!-- 商品削除フォーム -->
